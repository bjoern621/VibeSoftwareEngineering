/**
 * FormSelect - Wiederverwendbare Select-Komponente mit React Hook Form Integration
 * 
 * Unterstützt automatische Fehleranzeige und optionale Platzhalter
 */
...
const FormSelect = ({
  ...
  return (
    <div className={`mb-4 ${className}`}>
      ...
      {/* Helper Text (Info-Text unter dem Select) */}
      {helperText && !error && (
