...
INSERT INTO meals (id, name, description, price, cost, stock, ingredients, calories, protein, carbs, fat) 
VALUES (1, 'Spaghetti Bolognese', 'Italienische Pasta mit Hackfleischsauce', 6.50, 3.20, 50, 'Nudeln, Hackfleisch, Tomatensauce, Zwiebeln', 650, 28.5, 75.0, 18.3);
...
INSERT INTO meals (id, name, description, price, cost, stock, ingredients, calories, protein, carbs, fat) 
VALUES (2, 'Veganer Burger', 'Burger mit pflanzlichem Patty', 7.90, 4.50, 30, 'Veganes Patty, Vollkornbrötchen, Salat, Tomate, Gurke', 480, 22.0, 52.0, 15.5);
...
INSERT INTO meals (id, name, description, price, cost, stock, ingredients, calories, protein, carbs, fat) 
VALUES (3, 'Hähnchen-Curry', 'Würziges Curry mit Reis', 8.50, 4.80, 40, 'Hähnchenbrust, Reis, Curry-Sauce, Gemüse', 720, 35.0, 68.0, 22.0);
...
INSERT INTO meals (id, name, description, price, cost, stock, ingredients, calories, protein, carbs, fat) 
VALUES (4, 'Caesar Salad', 'Frischer Salat mit Parmesan und Croutons', 5.90, 2.80, 25, 'Römersalat, Parmesan, Croutons, Caesar-Dressing', 380, 12.5, 28.0, 24.0);
...
INSERT INTO meals (id, name, description, price, cost, stock, ingredients, calories, protein, carbs, fat) 
VALUES (5, 'Glutenfreie Pizza', 'Pizza mit glutenfreiem Teig', 9.50, 5.20, 20, 'Glutenfreier Teig, Tomaten, Mozzarella, Basilikum', 580, 25.0, 62.0, 20.5);
