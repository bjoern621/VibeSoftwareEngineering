...
INSERT INTO meals (id, name, description, price, cost,  ingredients, calories, protein, carbs, fat) 
VALUES (6, 'Tomatensuppe', 'Cremige Tomatensuppe mit frischen Kräutern', 4.50, 2.10, 'Tomaten, Sahne, Zwiebeln, Knoblauch, Basilikum', 280, 6.5, 32.0, 12.0);
...
INSERT INTO meals (id, name, description, price, cost,  ingredients, calories, protein, carbs, fat) 
VALUES (7, 'Fischfilet mit Reis', 'Gebratenes Fischfilet mit Basmatireis und Gemüse', 9.90, 5.80, 'Seelachsfilet, Reis, Brokkoli, Karotten, Zitrone', 520, 38.0, 55.0, 12.5);
...
INSERT INTO meals (id, name, description, price, cost,  ingredients, calories, protein, carbs, fat) 
VALUES (8, 'Schnitzel mit Pommes', 'Knuspriges Schweineschnitzel mit goldenen Pommes', 8.90, 4.90, 'Schweineschnitzel, Paniermehl, Kartoffeln, Öl', 820, 42.0, 68.0, 38.0);
...
INSERT INTO meals (id, name, description, price, cost,  ingredients, calories, protein, carbs, fat) 
VALUES (9, 'Vegane Bowl', 'Quinoa-Bowl mit Kichererbsen und Avocado', 7.50, 3.90, 'Quinoa, Kichererbsen, Avocado, Spinat, Paprika', 450, 18.0, 52.0, 16.5);
...
-- Gericht 10: Lasagne
INSERT INTO meals (id, name, description, price, cost,  ingredients, calories, protein, carbs, fat) 
VALUES (10, 'Lasagne', 'Klassische italienische Lasagne mit Béchamelsauce', 7.80, 4.20, 'Lasagneplatten, Hackfleisch, Tomatensauce, Béchamelsauce, Käse', 680, 32.0, 58.0, 28.5);
...
INSERT INTO meals (id, name, description, price, cost,  ingredients, calories, protein, carbs, fat) 
VALUES (11, 'Apfelstrudel', 'Hausgemachter Apfelstrudel mit Vanillesauce', 3.90, 1.80, 'Äpfel, Blätterteig, Zimt, Rosinen, Vanillesauce', 320, 5.5, 48.0, 12.0);
...
INSERT INTO meals (id, name, description, price, cost,  ingredients, calories, protein, carbs, fat) 
VALUES (12, 'Schokoladenmousse', 'Cremige Schokoladenmousse', 3.50, 1.50, 'Dunkle Schokolade, Sahne, Eier, Zucker', 380, 6.0, 35.0, 24.0);
...
INSERT INTO meals (id, name, description, price, cost,  ingredients, calories, protein, carbs, fat) 
VALUES (13, 'Gemüsepfanne', 'Bunte Gemüsepfanne mit Reis', 6.90, 3.50, 'Paprika, Zucchini, Aubergine, Reis, Sojasauce', 420, 12.0, 68.0, 8.5);
...
INSERT INTO meals (id, name, description, price, cost,  ingredients, calories, protein, carbs, fat) 
VALUES (14, 'Rindergulasch', 'Deftiges Rindergulasch mit Spätzle', 9.50, 5.50, 'Rindfleisch, Paprika, Zwiebeln, Spätzle', 750, 45.0, 62.0, 28.0);
...
-- Gericht 15: Tiramisu
INSERT INTO meals (id, name, description, price, cost,  ingredients, calories, protein, carbs, fat) 
VALUES (15, 'Tiramisu', 'Italienisches Tiramisu mit Mascarpone', 4.50, 2.20, 'Löffelbiskuits, Mascarpone, Kaffee, Kakao, Eier', 420, 8.5, 42.0, 22.0);
