...
/**
 * Request DTO für Concert-Update (PUT /api/concerts/{id}).
 * 
 * Validierung:
 ...
 */
@Schema(description = "Request zum Aktualisieren eines bestehenden Konzerts")
public class UpdateConcertRequestDTO {
    ...
    public UpdateConcertRequestDTO() {}
    
    public UpdateConcertRequestDTO(String name, LocalDateTime date, String venue, String description) {
        this.name = name;
        this.date = date;
        this.venue = venue;
