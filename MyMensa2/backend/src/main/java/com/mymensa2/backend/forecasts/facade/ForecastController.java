...
public class ForecastController {
    ...
    // Endpoint 23: Wareneinsatz-Prognose
    @GetMapping("/forecasts/demand")
    public ResponseEntity<ForecastResponseDTO> getDemandForecast(
        @RequestParam String startDate,
        @RequestParam String endDate
    ) {
        ForecastResponseDTO forecast = forecastService.getDemandForecast(startDate, endDate);
        return ResponseEntity.ok(forecast);
    }
    
    // Endpoint 24: Nachhaltigkeits-Bericht
