...
public class Ingredient {
    ...
    public Ingredient(String name, String unit, Float stockQuantity, Float minStockLevel, 
                     Float pricePerUnit, String supplierId) {
        this.name = name;
        this.unit = unit;
    ...
    // Prüfung ob Nachbestellung nötig ist
